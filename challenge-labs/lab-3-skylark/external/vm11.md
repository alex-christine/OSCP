...
<figure><img src="../../../.gitbook/assets/SL-H01-SystemPsExec.png" alt=""><figcaption></figcaption></figure>
...
This is not exactly post-exploit but after compromising the machine, I eventually found credentials for the "Partner Portal" in a [file on the `LAB` machine](../subnet-10.10.xxx.0-24/lab.md#interesting-files). I am able to log in to the portal and access a `/upload` page but I am not sure how much value this provides me yet.

### Manual Enumeration

As I am looking around the `C:\Program Files` directory I see the UltraVNC files under `\uvnc bvba\UltraVNC`. In this directory I find the `ultravnc.ini` configuration file which when opened contains some encrypted passwords:

<figure><img src="../../../.gitbook/assets/SL-H05-POST-VncCreds.png" alt=""><figcaption><p>Credentials found in VNC configuration files</p></figcaption></figure>

#### UltraVNC Password Decryption

I use the techniques described [here](https://github.com/frizb/PasswordDecrypts) and am able to decrypt the password with Metasploit:

<figure><img src="../../../.gitbook/assets/SL-H05-POST-MsfDecryptCreds.png" alt=""><figcaption><p>Decrypted credentials</p></figcaption></figure>

Once I have the password I start looking around for where it can be used. I find it accesses the VNC connection at port `5901` on `RD` (at this point I still knew it as `VM5`).
