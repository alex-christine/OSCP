...
I extracted the `SAM` file with no issues but had a problem with `SYSTEM`. I have seen this before with large files where they come up with the "no file uploaded" error in PHP. I have not had time to examine why. Anyway I decide to try compressing it. I use [this technique](https://stuartmccoll.github.io/posts/2022-05-28-use-powershell-to-create-a-zip-file/) to add a single file to a zip and upload that:
