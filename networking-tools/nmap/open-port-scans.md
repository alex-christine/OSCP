...
| Flag   | Command                                                                                                                                                                                                            |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `-sA`  | [TCP ACK Scan](open-port-scans.md#tcp-ack-scan)                                                                                                                                                                    |
| `-sF`  | [TCP FIN Scan](open-port-scans.md#tcp-fin-scan)                                                                                                                                                                    |
| `-sI`  | [Zombie Scan](open-port-scans.md#zombie-scan)                                                                                                                                                                      |
| `-sM`  | [Maimon Scan](open-port-scans.md#maimon-scan)                                                                                                                                                                      |
| `-sN`  | [Null Scan](open-port-scans.md#null-scan)                                                                                                                                                                          |
| `-sS`  | [TCP SYN Scan](open-port-scans.md#tcp-syn-scan) (Default scan mode for root-level users)                                                                                                                           |
| `-sT`  | [TCP Connect Scan](open-port-scans.md#tcp-connect-scan) (Default scan mode for regular users)                                                                                                                      |
| `-sU`  | [UDP Scan](open-port-scans.md#undefined)                                                                                                                                                                           |
| `-sW`  | [Window Scan](open-port-scans.md#window-scan)                                                                                                                                                                      |
| `-sX`  | [XMAS Scan](open-port-scans.md#xmas-scan)                                                                                                                                                                          |
| custom | Triggered `--scanflags=<FLAGS>` where `URG`, `ACK`, `PSH`, `RST`, `SYN`, `FIN` can be used to specify flags. Multiple can be used with no spaces (e.g. `SYNRST` would send a packet with the SYN and RST flags set |
